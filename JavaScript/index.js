...
function AboutShow() {
    ...
    document.getElementById('sectionShowAbout').style.display = 'none'
}

function AboutHide() {
    document.getElementById('contAbout').style.display = 'none'
...
function EDShow() {
    ...
    document.getElementById('sectionShowED').style.display = 'none'
}

function EDHide() {
    document.getElementById('contED').style.display = 'none'
...
function SkillsShow() {
    ...
    document.getElementById('sectionShowSkills').style.display = 'none'
}

function SkillsHide() {
    document.getElementById('contSkills').style.display = 'none'
...
function ResumeShow() {
    ...
    document.getElementById('sectionShowResume').style.display = 'none'
}

function ResumeHide() {
    document.getElementById('contResume').style.display = 'none'
...
function ContactShow() {
    ...
    document.getElementById('sectionShowContact').style.display = 'none'
}
